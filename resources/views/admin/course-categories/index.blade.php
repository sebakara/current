        ...
        <div class="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
            <div>
                ...
                <p class="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-500">
                    Organise Academy courses into clear learning disciplines.
                </p>
            </div>
                            ...
                            <tr class="transition hover:bg-slate-100 dark:hover:bg-white/[0.02]">
                                <td class="px-6 py-5">
                                    <div class="flex items-start gap-4">
                                        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-brand-primary/15 bg-brand-primary/[0.07] text-sm font-black text-brand-primary dark:text-brand-primary-light">
                                            {{ $category->icon
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <form
                                            ...
                                            onsubmit="return confirm('Delete this course category?')"
                                        >
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    <p class="mt-2 text-sm text-slate-600 dark:text-slate-600">
                                        Create the first Academy category.
                                    </p>
                                </td>
                            </tr>
                        @endforelse
